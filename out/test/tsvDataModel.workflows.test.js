...
describe('TSVDataModel - Complex Workflows', () => {
    describe('Simulated User Editing Workflows', () => {
        ...
        it('should handle Excel-like Enter behavior workflow', () => {
            ...
            const model = new tsvDataModel_1.TSVDataModel('Section\tHeader\n\tData1\tValue1\n\tData2\tValue2');
        ...
        it('should handle Tab at end of row to add column', () => {
            ...
            const model = new tsvDataModel_1.TSVDataModel('A\tB\nX\tY');
        ...
        it('should handle Backspace at beginning of last cell to remove column', () => {
            ...
            const model = new tsvDataModel_1.TSVDataModel('A\tB\tC\nX\tY\tZ');
    ...
    describe('Data Integrity and Consistency', () => {
        it('should maintain consistency through round-trip operations', () => {
            ...
            const model1 = new tsvDataModel_1.TSVDataModel(originalTSV);
            model1.insertRowAfter(2);
            model1.updateCell({ position: { row: 3, col: 0 }, value: 'New' });
            const modifiedTSV = model1.toTSV();
            const model2 = new tsvDataModel_1.TSVDataModel(modifiedTSV);
        ...
        it('should handle edge case sequences gracefully', () => {
            const model = new tsvDataModel_1.TSVDataModel('A');
            ...
            const reconstructed = new tsvDataModel_1.TSVDataModel(tsv);
            assert.deepStrictEqual(reconstructed.getData(), data);
        });
    });
});
//# sourceMappingURL=tsvDataModel.workflows.test.js.map